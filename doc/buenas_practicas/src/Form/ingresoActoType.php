...
class ingresoActoType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $builder->add('nroNota', IntegerType::class, [
                ...
                ->add('localidad', EntityType::class, array(
                    'class' => 'App\Entity\tablascomunes\TLoc',
                    'em' => 'default',
                ...
                /*
                  ->add('arrayComponenteDescripcion', ChoiceType::class, array(
                  'mapped' => false,
                  'required' => false,
                  'label' => 'Componente',
                  'multiple' => true,
                  'choice_label' => 'componente',
                  'placeholder' => 'Todos',
                  )) */
                /* ->add('arrayComponenteDescripcion', EntityType::class, array(
                  'mapped' => true,
                  'required' => true,
                  'label' => 'Componente',
                  'multiple' => true,
